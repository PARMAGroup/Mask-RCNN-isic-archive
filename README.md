...
repository and longcw's [RoiAlign](https://github.com/longcw/RoIAlign.pytorch).
    ...
    | GTX 1080 (Ti) | sm_61 |
        ...
        cd nms/src/cuda/
        /usr/local/cuda/bin/nvcc -c -o nms_kernel.cu.o nms_kernel.cu -x cu -Xcompiler -fPIC -arch=sm_61
        cd ../../
        python3 build.py
        cd ../

        cd roialign/roi_align/src/cuda/
        /usr/local/cuda/bin/nvcc -c -o crop_and_resize_kernel.cu.o crop_and_resize_kernel.cu -x cu -Xcompiler -fPIC -arch=sm_61
        cd ../../
        python3 build.py
        cd ../../
